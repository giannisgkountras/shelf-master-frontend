...
const WarehouseCard = ({ warehouse, selectedEntity, setSelectedEntity }) => {
    ...
    return (
        <div
            className={`w-1/6 h-52 min-w-64 ${selectedEntity?.id === warehouse.id ? 'bg-secondary/50' : 'bg-[#fff]'} rounded-2xl shadow-2xl relative m-4 hover:scale-105 transition-all duration-150 hover:cursor-pointer`}
        ...
        >
            <div className='flex flex-col justify-center items-center h-full'>
                ...
                <p className='text-black font-semibold mt-2 text-3xl'>
                    {street}
                </p>
